About geant4-data-radioactivedecay
==================================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/geant4-data-radioactivedecay-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6493&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/geant4-data-radioactivedecay-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `geant4-data-radioactivedecay` can be installed with:

```
conda install geant4-data-radioactivedecay
```

It is possible to list all of the versions of `geant4-data-radioactivedecay` available on your platform with:
